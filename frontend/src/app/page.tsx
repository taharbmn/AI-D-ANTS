  ...
  return (
    <div className="flex gap-6 flex-grow">
      <div className="bg-neutral-800 relative flex-grow rounded-4xl flex flex-col">
        <div className="w-full max-h-[93.5vh] flex flex-col items-center justify-end pb-4">
          <div className="w-full flex flex-col pb-56 px-24 gap-6 overflow-y-auto py-4 custom-scrollbar">
        ...
        <div className="h-[200px] w-[600px] left-1/2 transform -translate-x-1/2 absolute bottom-4 flex items-center justify-center px-6">
